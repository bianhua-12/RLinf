...
Gradient flow:
  freeze_vlm=True  : vision tower, projector, and Gemma3 params frozen; KV cache
                     detached in _forward_expert_two_stage
  freeze_vlm=False : full VLM stack trainable; gradients flow through KV into Gemma3
"""
...
class SiglipGemma3WithMultiExpert(nn.Module):
    ...
    Args:
        ...
        freeze_vlm: If True, freeze the full VLM stack (vision tower, projector,
            and Gemma3) so only experts train.
